package com.gxg.administrator.mydemo7.shijuexiaoguo;
...
public class ShiJueTeXiaoActivity extends AppCompatActivity implements View.OnClickListener {

    @Bind(R.id.magic_line)
    MagicLineView magicLineView;
    @Bind(R.id.p1x_length)
    EditText p1xLength;
    @Bind(R.id.p1y_length)
    EditText p1yLength;
    @Bind(R.id.p2x_length)
    EditText p2xLength;
    @Bind(R.id.p2y_length)
    EditText p2yLength;
    @Bind(R.id.p1_speed)
    EditText p1Speed;
    @Bind(R.id.p2_speed)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shi_jue_te_xiao);
