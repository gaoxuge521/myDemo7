package com.gxg.administrator.mydemo7.headscroll.view;
...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private static final int ANIMATE_TO_START_DURATION = 800;
...
//        layoutParams.addRule(RelativeLayout.CENTER_IN_PARENT);
        ...
        mHeadViewContainer.setVisibility(View.GONE);
        mHeadViewContainer.setPadding(10,10,10,10);
//        defaultProgressView.setVisibility(View.VISIBLE);
//        defaultProgressView.setOnDraw(false);


        //自定义
        View view = View.inflate(getContext(), R.layout.refresh_view,null);

        //加载gif图
//        GifImageView gifImageView = new GifImageView(getContext());
//        gifImageView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
//        gifImageView.setImageResource(R.drawable.loading);
//        mHeadViewContainer.addView(gifImageView, layoutParams);
...
//        Log.d(LOG_TAG, "debug:onLayout childHeight = " + childHeight);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                float xDiff = Math.abs(mInitialMotionX - x);
     ...
     * Adapter
     */
    public class OnPullRefreshListenerAdapter implements OnRefreshListener {
